...
DAYS={
 ...
 2:[('06:25','キャンプ 屋我地','Camp, Yagaji',26.64820,128.03368),
    ...
    ('14:35','名護 買い出し','Nago groceries',26.60700,127.97942),
    ('16:45','あざまサンサンビーチ','Azama Sun Sun Beach',26.17810,127.82925)],
 3:[('06:26','あざまサンサンビーチ','Azama Sun Sun Beach',26.17810,127.82925),
    ('08:30','知念岬公園','Chinen Misaki Park',26.16666,127.82992),
    ('10:30','浜辺の茶屋 新原','Hamabe no Chaya, Mibaru',26.13353,127.78461),
    ('12:30','大度浜海岸','Odohama Beach',26.09047,127.70848),
    ('13:10','喜屋武岬','Cape Kyan',26.07842,127.66895),
...
KIND={(1,1):'bus',(1,2):'walk',(2,2):'boat',(2,3):'boat',(3,7):'walk',(3,8):'bus'}
